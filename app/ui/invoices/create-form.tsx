            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  className="w-4 h-4 text-gray-600 bg-gray-100 border-gray-300 focus:ring-2 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-gray-600"
                />
                <label
                  htmlFor="pending"
